...
public class OracleJDBC {
	...
	public void selectRecordsFromDbFlightTable(String flightDate, String airlinesCode, String flightNumber, String departureCode, String destinationCode, String gate, String flightType) throws SQLException {
		...
		String selectTableSQL = "SELECT * " +
								...
								"AND FI_MAHANGHANGKHONG = '" + airlinesCode + "' " +
								"AND FI_SOCHUYENBAY LIKE '%" + flightNumber + "%' " +
								"AND FI_MACANGHANGKHONGDI = '" + departureCode + "' " +
								"AND FI_MACANGHANGKHONGDEN = '" + destinationCode + "' " +
								"AND FI_CUA = '" + gate + "' " +
								"AND FI_LOAIDIDEN = '" + flightType + "';";
